                        ...
                        <div className="card" style={{borderRadius: '15px'}}>
                            <div className="card-body p-5">
                                ...
                                <ul className="list-group mb-0">
                                    {tasks.map(task => {
                                        return (
                                            <li className="list-group-item d-flex justify-content-between align-items-center border-start-0 border-top-0 border-end-0 border-bottom rounded-0 mb-2" key={task.id}>
